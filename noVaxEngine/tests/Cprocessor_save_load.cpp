...
#define PATH "../noVaxEngine/tests/file"
#define PATH_TEST PATH "/Cprocessor_save_load/"

    TEST(Cprocessor, load_1) {
        Cprocessor proc1;
        proc1.load(PATH_TEST"1.v11");
...
TEST(Cprocessor, load_save_load_1) {
    ...
    Cprocessor proc2;
    proc1.load(PATH_TEST"1.v11");
    proc1.save(PATH_TEST"test_1.v11");
    proc2.load(PATH_TEST"test_1.v11");
    EXPECT_EQ(proc1,proc2);
}

TEST(Cprocessor, load_2) {
    Cprocessor proc1;
    proc1.load(PATH_TEST"2.v11");
...
TEST(Cprocessor, load_save_load_2) {
    ...
    Cprocessor proc2;
    proc1.load(PATH_TEST"2.v11");
    proc1.save(PATH_TEST"test_2.v11");
    proc2.load(PATH_TEST"test_2.v11");
    EXPECT_EQ(proc1,proc2);
}
